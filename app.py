...
logger = logging.getLogger("app1-logger")
...
def get_all_students():
    ...
    try:       
        ...
        if students:        
            ...
            logger.info("app 1 Viwed student data", extra={"tags": {"service": "my-service"}})               
            return (students), 200
        else:
            logger.info("App 1 NO student data available ",exc_info=True, extra={"tags": {"service": "my-service"}})
